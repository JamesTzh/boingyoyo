...
import { Activity, ShieldAlert, ShieldCheck, TrendingDown, Users } from 'lucide-react';
...
// What every Scam School play reveals about real-world vulnerability — the
// labelled signal the fraud model trains on, shown here for the trust team.
export function ScamIntelligenceTab() {
  ...
  return (
    <div>
      <AdminPageHeader
        ...
        title="Which scams fool real buyers"
        subtitle="Every Phish n Cheats play is a labelled fraud signal. This is the ground truth the detection model learns from — and where the trust team should defend next."
        chips={[`${total.toLocaleString()} labelled plays`, ...(live.length ? ['includes your play'] : [])]}
      />
